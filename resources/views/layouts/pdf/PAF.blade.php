...
<table style="width: 100%;">
    <tr>
        ...
        <td style="height: {{count($application->automationable->data_array["active_salary_details"]["advantages"]) == 0 ? "200px" : (strval(200-(count($application->automationable->data_array["active_salary_details"]["advantages"]) * 5))) ."px"}};text-align: center;vertical-align: top;width: 45%">

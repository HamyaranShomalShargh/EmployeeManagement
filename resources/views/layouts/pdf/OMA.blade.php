...
@if(isset($test) && $test)
    <div class="letter-body">
        ...
        <p class="nazanin" style="text-align: justify;line-height: 25px;font-size: 15px">
            ...
            که متقاضی کار در اين شرکت می باشد، در اجرای ماده 90 قانون تأمين اجتماعی جمهوری اسلامی، خواهشمند است دستور فرمایید پس از احراز هويت درقبال اخذ هزينه های متعلقه، معاینات پزشکی و آزمایش عدم اعتیاد از نامبرده به عمل آورده و نتيجه را به اين شرکت، به آدرس
